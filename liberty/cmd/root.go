...
func init() {
	...
	RootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.liberty.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".liberty" (without extension).
		viper.AddConfigPath(home)
		viper.AddConfigPath(configLocation)
		viper.AddConfigPath("/liberty")
		viper.SetConfigName(".liberty")
	}
